...
echo "--- Đang cài đặt ---"
sudo apt update
sudo apt -y -q install memtester
log_status "memtester"
sudo apt -y -q install smartmontools
log_status "smartmontools"
sudo apt -y -q install stress-ng
log_status "stress-ng"
